...
void init(VERTEX tab[2][2][2][2][height][width])
{
...
int testDijkstra()
{
    ...
    int n=10, m=15, t=0;
    char map[10][15] = {
                        {'H', 'H', 'H', 'H', 'H', 'C', 'H', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C'},
                        {'C', 'C', 'C', 'C', 'H', 'C', 'C', 'C', 'C', 'C', 'C', '2', 'C', 'C', 'C'},
                        ...
                        {'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', '2', 'N', 'C'},
                        {'C', 'C', 'C', 'P', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'N', 'C'},
                        {'C', 'C', 'C', 'C', 'C', '1', 'P', 'C', 'C', 'C', 'C', 'C', 'C', 'N', 'D'}
                        };
